...
<table class="table-form" border="1" width="100%">
	<tr>
		...
		<th>原金额</th><td><input type="text" name="oldmoney" class="ipt"></td>
	</tr>
	<tr>
		<th>新金额</th><td><input type="text" name="newmoney" class="ipt"></td>
	</tr>
	
	
	<tr>
		<th>修改原因</th><td><textarea name="info" id="" cols="30" rows="10"></textarea></td>
	</tr>
	<tr>
