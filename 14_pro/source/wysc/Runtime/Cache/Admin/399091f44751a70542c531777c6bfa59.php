...
<table class="table-form" border="1" width="100%">
	<tr>
		<th>名称</th><td><input type="hidden" name="id" value="<?php echo ($data[id]); ?>"><input type="text" name="shipname" class="ipt" value="<?php echo ($data[shipname]); ?>"></td>
	</tr>
	<tr>
		<th>描述</th><td><textarea name="shipdesc" id="" cols="30" rows="10" style="margin: 0px; width: 609px; height: 150px;"><?php echo ($data[shipdesc]); ?></textarea></td>
	</tr>
	<tr>
		<th>收取费用</th><td><input type="text" name="extramoney" class="ipt" value="<?php echo ($data[extramoney]); ?>"></td>
	</tr>
	<tr>
