        ...
        <div  class="easyui-panel" data-options="
            ...
            <form name="f1" action="" method="POST" enctype="multipart/form-data">   
                <table class="table-form" border="1" width="100%">
                    <tr><th>名称</th><td><input type="text" name="shipname" class="ipt" /></td></tr>
                    <tr><th>描述</th><td><textarea name="shipdesc" id="" cols="30" rows="10" style="margin:0px; width:609px; height:150px;"></textarea></td></tr>
                    <tr><th>收取费用</th><td><input type="text" name="extramoeny" class="ipt" /></td></tr>                    
