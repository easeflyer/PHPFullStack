            ...
            <form name="f1" action="" method="post">
                <input type="hidden" name="id" value="<?php echo ($data['id']); ?>" />
                    <table class="table-form" border="1" width="100%">
                        <tr>
                            <th>分类名称</th><td><input type="text" name="catname" class="ipt" value="<?php echo ($data[catname]); ?>"></td>
                        </tr>
                        <tr>
                            <th>上级分类</th><td><select id="cc"  name="pid" class="easyui-combotree" style="width:200px;" data-options="
                                                     url:'<?php echo U('News/combotreejson');?>',
                                                     value:'<?php echo ($data[pid]); ?>'"></select> </td>
                        </tr>
                        <tr>
