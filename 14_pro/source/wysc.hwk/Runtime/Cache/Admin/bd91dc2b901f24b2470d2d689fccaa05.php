            ...
            <form name="f1" action="" method="post" enctype="multipart/form-data">   
                <table class="table-form" border="1" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="cc"  name="newscate_id" class="easyui-combotree" style="width:200px;"   
                                    ...
                                    value:'<?php echo ($data[newscate_id]); ?>'">
                            </select>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>是否为跳转链接</th>
                        <td>
                            <input type="radio" value="0" name="isjump" onclick="setjump(this)" 
                                   <?php if($data[isjump] == 0): ?>checked<?php endif; ?>
                                />否&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <input type="submit" name="s1" value="提交" />&nbsp;<input type="reset" name="r1" value="清除" />
                        </td>
                    </tr>
                </table> 
            </form>  
