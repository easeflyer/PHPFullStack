...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><?php echo ($catedata[catname]); ?>-3C商城<</title>
        ...
        <style>
            .right *{color: #666666;}
            .newstitle{font-size: 14px;text-align: left;height: 2em;line-height: 2em; color: #666666;border-bottom:1px solid #ccc; padding-bottom: 10px;padding-left:20px;}
            .newslist *{font-size: 14px; }
            .newslist li{ height: 2em;line-height: 2em; padding-left: 20px;padding-bottom: 6px;border-bottom:1px dotted #ccc; padding-top: 6px;}
            .addtime{float: right;margin-right: 20px;}
        </style>
    </head>
    <body>
        <!--顶部导航开始-->
