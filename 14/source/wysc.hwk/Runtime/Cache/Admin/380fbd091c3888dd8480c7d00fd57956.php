    ...
    a{text-decoration:none; color:#000;}
        ...
        <script>
            ...
            function createop(_v, _r) {
                return "<a href='index.php?g=admin&m=news&a=newsedit&id=" + _r.id + "' class='easyui-linkbutton' data-options='iconCls:\"icon-drive_edit\"'>编辑</a><a href='javascript:void(0)'  onclick='confirmdel(" + _r.id + ")' class='easyui-linkbutton'   data-options='iconCls:\"icon-cancel\"'>删除</a>";
            }
            ...
            function gotopage(_page, _pagesize) {
                ...
                window.location.href = 'index.php?g=admin&m=News&a=newsmanage&' + _searchstr + '&page=' + _page;
            }
        </script>
    </head>
    <body>
