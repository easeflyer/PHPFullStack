        ...
        <div  class="easyui-panel" data-options="
            ...
            <form name="f1" action="" method="POST" enctype="multipart/form-data">   
                <table class="table-form" border="1" width="100%">
                    <tr><th>订单状态</th><td><input type="hidden" name="id" value="<?php echo ($data[id]); ?>" /><input type="text" name="state" class="ipt" value="<?php echo ($data[state]); ?>"/></td></tr>
                    <tr><th>描述</th><td><textarea name="info" id="" cols="30" rows="10" style="margin:0px; width:609px; height:150px;"><?php echo ($data[info]); ?></textarea></td></tr>
