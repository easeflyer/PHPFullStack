...
<div class="wrap">
    ...
    <!--头部结束-->
        <div class="position">
            <h6>当前位置：</h6><a href="__APPURL__">首页 </a><span>&gt;</span><a href="<?php echo U('User/ucenter');?>"> 用户中心 </a><span>&gt;</span><a href="<?php echo U('User/ucenter',array('option'=>'selfcomment'));?>"> 个人收藏</a>
        </div>
        <div class="main">
            <div class="left">
    <!--当前分类开始-->
    <div class="currencat">
        ...
        <div class="curcatbt">
            ...
            <div class="right">
                ...
                <div id="page" style="margin-top:15px;"><?php echo ($pageshow); ?></div>
            </div>
        </div>
        <div class="footer">
