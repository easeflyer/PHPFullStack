...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="__SKIN__/css/ucentermenu.css" rel="stylesheet" type="text/css" />
        <link href="__SKIN__/css/ucenter.css" rel="stylesheet" type="text/css" />
...
<div class="wrap">
    ...
    <!--头部结束-->
        <div class="position">
            <h6>当前位置：</h6><a href="__APPURL__Home">首页</a><span>&gt;</span><a href="<?php echo U('User/ucenter');?>">用户中心</a><span>&gt;</span><a href="<?php echo U('User/ucenter',array('option'=>'selforder'));?>">个人订单管理</a>
        </div>
        <div class="main">
            <div class="left">
    <!--当前分类开始-->
            ...
            <div class="right">
                <form name="f1" action="" method="POST" enctype="multipart/form-data">
                    <table class="table-form" border="0" width="100%">
                        ...
                        <?php if(is_array($goodsdata)): $i = 0; $__LIST__ = $goodsdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><img src="<?php if($item[goods_thumb]): ?>__APPURL__/Public/Uploads/<?php echo ($item[goods_thumb]); ?>
                                        <?php else: ?>
                                        __SKIN__/images/nopic.png<?php endif; ?>" width="64" height="64"></td>
                    ...
                    <table class="table-form" border="0" width="100%">
                        ...
                        <tr>
                            <th>标志建筑</th><td style="width:270px"><?php echo ($addressdata[signbuild]); ?></td>
