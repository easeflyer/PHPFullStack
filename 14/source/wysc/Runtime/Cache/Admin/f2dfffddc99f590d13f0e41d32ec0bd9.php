            ...
            <form name="f1" action="" method="POST">
                ...
                <table class="table-form" border="1" width="100%">
                    ...
                    <tr>
                        <th>单位</th>
                        <td>
                            <input type="text" name="dw" class="ipt" value="<?php echo ($data['dw']); ?>">
                        </td>
                    </tr>
                    <tr>
                        <th>是否显示</th>
                        <td>
                            <?php if($data['is_show'] == 1): ?><input name="is_show" type="radio" value="1" checked />是&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input name="is_show" type="radio" value="0">否</td>
                                    <?php else: ?>
                                    <input name="is_show" type="radio" value="1" />是&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
                                    <input name="is_show" type="radio" value="0" checked />否</td><?php endif; ?>
                    </tr>
                    <tr>
                        <th></th>
                        <td>
