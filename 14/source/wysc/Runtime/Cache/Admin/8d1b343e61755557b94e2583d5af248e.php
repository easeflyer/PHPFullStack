...
a{text-decoration:none; color:#000}
    ...
    <body>
        <div class="easyui-panel" data-options="
            ...
            <div id="toolbar">
                <a href="<?php echo U('Attrlist/addattrlist',array(attrid=>$attrid));?>" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-chart_organisation_add'">添加商标属性</a>
                <a href="<?php echo U('Goodattr/managegoodattr');?>" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-page_white_go'">返回模型列表</a>
            </div>
        </div>
    </body>
