...
<div class="wrap">
    ...
    <div class="main">
        <div class="shopflow">
                ...
                <form name="f1" action="<?php echo U('shoppingflow/step',array('step'=>'shoppingaddress'));?>" id="addressform" method="POST" enctype="multipart/form-data">
                    <table class="table-form" border="1" width="100%">
                        ...
                        <?php if(is_array($addressdata)): $i = 0; $__LIST__ = $addressdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                <td colspan="4" style="padding: 10px 10px; text-align:left !important; font-weight:bold; color:red">选择该地址&nbsp;&nbsp;&nbsp;
                                    <input type="radio" name="addressid" value="<?php echo ($val["id"]); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>收货人</th>
                                <td colspan="3" align="left" style="text-align:left !important">
                                    <input type="text" name="contact" class="ipt" style="width: 336px;" value="<?php echo ($val["contact"]); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>详细地址</th>
                                <td colspan="3" style="text-align:left !important">
                                    <input type="text" name="address" class="ipt" style="width: 500px; " value="<?php echo ($val["address"]); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>电话</th>
                                <td style="width:270px; text-align:left !important">
                                    <input type="text" name="tel" class="ipt" style="width:200px" value="<?php echo ($val["tel"]); ?>">
                                </td>
                                <th>手机</th>
                                <td style="text-align:left !important">
                                    <input type="text" name="phone" class="ipt" style="width:200px" value="<?php echo ($val["phone"]); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>标志建筑</th>
                                <td style="width:270px;text-align:left !important">
                                    <input type="text" name="signbuild" class="ipt" style="width:200px" value="<?php echo ($val["signbuild"]); ?>">
                                </td>
                                <th>最佳送货时间</th>
                                <td style="text-align:left !important">
                                    <input type="text" name="besttime" class="ipt" style="width:200px" value="<?php echo ($val["besttime"]); ?>">
                                </td>
            ...
            <div class="nextbtn">
                <!--点击下一步提交收货地址表单 到 shoppingaddress 方法-->
