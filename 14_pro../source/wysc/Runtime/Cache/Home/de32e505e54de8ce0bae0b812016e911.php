...
<div class="wrap">
    ...
    <div class="position">
        <h6>当前位置：</h6><a href="__APPURL__">首页</a><span>&gt;</span><a href="<?php echo U('User/ucenter');?>">用户中心</a><span>&gt;</span><a href="<?php echo U('User/ucenter',array('option'=>'selfcomment'));?>">个人评论</a>
    </div>
    <div class="main">
        <div class="left">
    <!--当前分类开始-->
        ...
        <div class="right">
            <form name="f1" action="" method="POST" enctype="multipart/form-data">
                <table class="table-form" border="1" width="100%">
                    ...
                    <?php if(is_array($commentdata)): $i = 0; $__LIST__ = $commentdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                            <td align="center"><a href="<?php echo U('Index/show',array('goodid'=>$item[id]));?>"><img src="<?php if($item[thumb]): ?>__APPURL__/Public/Uploads/<?php echo ($item[thumb]); ?>
                <?php else: ?>
                __SKIN__images/nopic.png<?php endif; ?>" width="64" height="64"></a></td>
                            <td><a href="<?php echo U('Index/show',array('goodid'=>$item[id]));?>"><?php echo (mb_substr($item[goodsname],0,8,'utf-8')); ?></a></td>
                            <td><?php echo ($item[content]); ?></td>
                          
                            <td align="center"><a href="<?php echo U('User/ucenter',array(option=>'delcomment','commentid'=>$item[id]));?>"><span style="color:red">删除评论</span></a></td>
