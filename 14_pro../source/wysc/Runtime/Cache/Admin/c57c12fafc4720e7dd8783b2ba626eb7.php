...
<table class="table-form" border="1" width="100%">
	<tr>
		<th>订单状态</th><td><input type="text" name="state" class="ipt"></td>
	</tr>
	<tr>
		<th>描述</th><td><textarea name="info" id="" cols="30" rows="10" style="margin: 0px; width: 609px; height: 150px;"></textarea></td>
	</tr>
