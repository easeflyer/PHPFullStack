...
var str1 = "123"; 
document.write(Number(str1)+"\t（123数值字符串）<br />");

var str2 = ""; 
document.write(Number(str2)+"\t(0空字串)<br />");

var str3 = "a323bc"; 
document.write(Number(str3)+"\t(nan字串)<br />");
...
var str7 = null;
document.write(String(str7)+"\t(null转换成字符串)<br />");
var str7 = undefined ;
document.write(String(str7)+"\t(undefined转换成字符串)<br />");
var str7 = true;
document.write(String(str7)+"\t(转换成字符串)<br />");
document.write("<br />-------------array.toString--------------<br />");
var arr1;
arr1 = [1,2,3,4]; // 定义了一个数组。

document.write(arr1.toString()+"---abcde"+ arr1[1]);

document.write("<br />-------------boolean--------------<br />");
document.write(Boolean(23423)+ "----boolean");
...
document.write(n3 + "---取余数"); // 5
document.write("<br />");


document.write(""+1+3);     // 13
document.write("<br />");
