...
//var str4 = "q";
var str4 = "2323"; // true
document.write(mode4.test(str4));
...
var str4 = "gooooogle";
var reg4 = new RegExp("go{2,3}gle");  //   g.*gle
...
document.write("<br />------------（）------------<br />")
var str7 = "aaa4322323232342341414aaa";  // 字符匹配 0个到任意多
//正则反向引用： （）   后边如果再用 \1 转义字符去调用  \\ 转义\为控制符  \1
// 应为是用的 regexp 后面的是字符串，因此是 \\1
var reg7 =  new RegExp("^([a-z]{3})[0-9]{1,}\\1$"); 
var reg6 = /^([a-z]{3})[0-9]{1,}\1$/;  // 和上面的正则一样。
wt("reg7:" + reg7.test(str7));
wt(reg6.test(str7));
document.write("<br />------------|------------<br />")
var str8 = "cn";
//var str8 = "cs"; // false
var reg8 =  new RegExp("com|cn|org|net");
document.write("reg8:"+reg8.test(str8))

document.write("<br />");

document.write("^([a-z]{3})[0-9]{1,}\\1$");
