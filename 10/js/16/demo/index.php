...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            //document.getElementById("dv1").innerHTML = "a.php?random=" + Math.random();
            ...
            bt1.onclick = function () {
                ...
                // ajax 有缓存  在open中的url上绑定一个随机数。因为 url 发生了变化，因此避免了缓存。  get post
                //http://localhost/a.php?a=1&b=2&c=3    a.php,a.php
