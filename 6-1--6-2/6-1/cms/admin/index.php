...
<BODY>
<TABLE height="530" cellSpacing=0 cellPadding=0 width="100%" bgColor=#002779  border=0>
  <TR>
    <TD align=middle>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width=230 border=0>
              ...
              <TR height=36>
                ...
                <TD><INPUT 
                  ...
                  maxLength=30 size=24 name="aName"></TD></TR>
              <TR height=36>
                <TD>&nbsp; </TD>
                <TD>口　令</TD>
                <TD><INPUT 
                  style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 1px solid; BORDER-LEFT: #000000 1px solid; BORDER-BOTTOM: #000000 1px solid" 
                  type=password maxLength=30 size=24 name="aPwd">
				  </TD>
			  </TR>
              <TR height=5>
                <TD colSpan=3></TD></TR>
