      ...
      <TBODY>
        ...
        <TR>
          <TD><TABLE id=submenu1 cellSpacing=0 cellPadding=0 width="100%" border=0>
            ...
            target=main>日志管理</A></TD>
                </TR>
                <TR>
                  <TD><IMG src="__PUBLIC__/Images/closed.gif"></TD>
                  <TD height=23><A href="Admin_Admin.asp" 
            target=main>管理员管理</A> </TD>
                </TR>
                <TR>
                  <TD><IMG src="__PUBLIC__/Images/closed.gif"></TD>
                  <TD height=23><A href="Admin_Data.asp" 
            target=main>数据库维护</A></TD>
                </TR>
                <TR>
                  <TD><IMG src="__PUBLIC__/Images/closed.gif"></TD>
                  <TD height=23><A href="Module_Admin.asp" 
            target=main>系统模块设置</A></TD>
                </TR>
              </TBODY>
          </TABLE></TD>
        </TR>
