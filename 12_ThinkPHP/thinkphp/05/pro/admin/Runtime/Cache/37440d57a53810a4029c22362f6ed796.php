          ...
          <TD><TABLE id=submenu4 cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
                <TR>
                  ...
                  <TD height=23><A href="__APP__/Users/index" target="rightFrame">会员3添加</A> </TD>
                </TR>
                <TR>
                  <TD><IMG src="__PUBLIC__/Images/closed.gif"></TD>
                  <TD height=23><A href="__APP__/Users/usersList" target="rightFrame">会3员列表</A></TD>
                </TR>
              </TBODY>
          </TABLE></TD>
        </TR>
...
<!-- 顶部菜单 <a href="__URL__/left/menuId/2"   -->
<?php elseif($menuId == 2): ?>

<tr><td>菜单2 还没有以后添加</td></tr>
